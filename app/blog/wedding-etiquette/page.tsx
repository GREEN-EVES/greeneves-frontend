        ...
        <>
            ...
            <article className="max-w-5xl mx-auto p-8 md:p-12 bg-white rounded-3xl shadow-xl -mt-20 relative z-20 border border-gray-100 font-sans">
                ...
                <p className="text-lg md:text-xl text-gray-700 mb-10 leading-relaxed">
                    Whether you’re a couple planning your big day or a guest attending one,
                    ...
                    fashion. Here’s your quick guide to navigating today’s wedding rules
                    — without the stress.
                </p>
                ...
                <section className="space-y-14">
                    ...
                    <div>
                        ...
                        <p className="text-lg text-gray-600 pl-8 leading-relaxed">
                            If your invitation doesn’t specify “+1,” assume it’s for you
                            only. Wedding guest lists are carefully curated and budgeted —
                    ...
                    <div>
                        ...
                        <p className="text-lg text-gray-600 pl-8 leading-relaxed">
                            It’s tempting to snap a photo, but trust the professionals. Be
                    ...
                    <div>
                        ...
                        <p className="text-lg text-gray-600 pl-8 leading-relaxed">
                            ...
                            spotlight — it’s the couple’s day to shine. Subtle elegance is
                    ...
                    <div>
                        ...
                        <p className="text-lg text-gray-600 pl-8 leading-relaxed">
                            If you’re the couple, send handwritten thank-you notes within a
                    ...
                    <div>
                        ...
                        <p className="text-lg text-gray-600 pl-8 leading-relaxed">
                            ...
                            own. And if they’ve requested a “phone-free” ceremony, honor that
                            wish entirely.
                        </p>
                    </div>
                </section>
                ...
                <footer className="text-center">
                    <p className="text-xl text-gray-700 font-light leading-relaxed">
                        ...
                        . Keep those at the heart of your celebration, and you’ll never go
                        wrong. 💖
                    </p>
                </footer>
            </article>
