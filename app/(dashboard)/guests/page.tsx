...
import { Users, Plus, Search, MoreHorizontal, Mail, Phone, ArrowLeft, Check, X, UserPlus } from "lucide-react";
	...
	const fetchGuests = async () => {
		try {
			...
			finalGuests = finalGuests.map((guest) => ({
				...guest,
				rsvpStatus: guest.rsvps && guest.rsvps.length > 0 ? guest.rsvps[0].response : "pending",
			}));
					...
					<div className="flex items-center space-x-4">
						...
						<div>
							...
							<p className="text-muted-foreground mt-2">
								{currentEvent
									? `Manage your ${
											currentEvent.eventType === "birthday" ? "birthday" : "wedding"
									  } guest list and track RSVPs`
						...
						<CardDescription>
							{currentEvent
								? `Manage your ${
								  ...
								  } guests and track their RSVP status`
