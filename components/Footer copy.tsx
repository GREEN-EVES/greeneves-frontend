      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-5 gap-10">
        ...
        <div className="col-span-2">
          ...
          <p className="mt-4 text-sm text-gray-400 leading-relaxed">
            Greeneves is authorised and regulated to provide digital financial
            services. Your deposits are safe and secured with our trusted
            partners and protected under global standards.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="#">Business Account</Link></li>
            <li><Link href="#">Point of Sale Terminal</Link></li>
            <li><Link href="#">Loan</Link></li>
            <li><Link href="#">Expense Card</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="#">Instant Debit Card</Link></li>
            <li><Link href="#">Personal Account</Link></li>
            <li><Link href="#">Payment</Link></li>
            <li><Link href="#">Personal Banking</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link href="#">Report a Vulnerability</Link></li>
